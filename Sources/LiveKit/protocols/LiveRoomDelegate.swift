...
public protocol LiveRoomDelegate {
    ...
    func room(_ room: LiveRoom, didUpdate connectionState: ConnectionState)
    ...
    func room(_ room: LiveRoom, participantDidJoin participant: RemoteParticipant)

    /// When a RemoteParticipant leaves after the local participant has joined.
    func room(_ room: LiveRoom, participantDidLeave participant: RemoteParticipant)
    ...
    func room(_ room: LiveRoom, didUpdate speakers: [Participant])

    /* All Participants */

    /// Participant's metadata has been changed
    func room(_ room: LiveRoom, participant: Participant, didUpdate metadata: String?)
    ...
    func room(_ room: LiveRoom, participant: Participant, didUpdate track: TrackPublication, muted: Bool)
    ...
    func room(_ room: LiveRoom, participant: RemoteParticipant, didPublish remoteTrack: RemoteTrackPublication)

    /// A RemoteParticipant has unpublished a track
    //    func didUnpublishRemoteTrack(publication: RemoteTrackPublication, particpant: RemoteParticipant)
    func room(_ room: LiveRoom, participant: RemoteParticipant, didUnpublish remoteTrack: RemoteTrackPublication)
    ...
    func room(_ room: LiveRoom, participant: RemoteParticipant, didSubscribe trackPublication: RemoteTrackPublication, track: Track)
    ...
    func room(_ room: LiveRoom, participant: RemoteParticipant, didFailToSubscribe trackSid: String, error: Error)
    ...
    func room(_ room: LiveRoom, participant: RemoteParticipant, didUnsubscribe trackPublication: RemoteTrackPublication)
